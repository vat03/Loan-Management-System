...
//   getPendingDocuments(loanId: number): Observable<DocumentResponseDTO[]> {
//     return this.http.get<DocumentResponseDTO[]>(`${this.apiUrl}/documents/getByLoanId/loan/${loanId}?status=PENDING_VERIFICATION`).pipe(
//       tap(docs => console.log('Fetched pending documents:', docs)),
//       catchError(this.handleError)
//     );
//   }
